...
void main() {
  ...
  testWidgets('HomePage renders the expected content', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const MyApp());
  ...
  testWidgets('Tapping the button does not throw and keeps the UI stable', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const MyApp());
  ...
  testWidgets('The app does not expose stale counter UI', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(const MyApp());
